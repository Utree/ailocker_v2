...
- (NSString*)abc:(CVPixelBufferRef)pixelBuffer {
    ...
    switch (input_tensor->type) {
        ...
        default:
            ...
            return @"Input data type is not supported by this demo app.";
    }
    ...
    for (const auto& result : top_results) {
        ...
        //      ラベル
        resultString = [NSString stringWithUTF8String:labels[index].c_str()];
        //      確率
